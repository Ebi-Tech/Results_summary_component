...
var RightSide = function () {
    return (React.createElement("div", { className: 'w-[50%] h=full p-5 flex flex-col ' },
        React.createElement("h2", null, "Summary"),
        React.createElement("div", { className: 'flex flex-col   ' },
            React.createElement("br", null),
            React.createElement("button", { className: 'flex flex-row w-full p-4 rounded-lg font-semibold items-centre\r\n             bg-Light-red bg-opacity-5' },
            ...
            React.createElement("br", null),
            React.createElement("button", { className: 'flex flex-row w-full  p-4 rounded-lg font-semibold items-center\r\n             bg-Orangey-yellow bg-opacity-5' },
        ...
        React.createElement("button", { className: 'flex flex-row  rounded-full items-center justify-center \r\n           w-full h-1 p-6 bg-gradient-to-b from-Violet-blue to-Persian-blue ' },
            React.createElement("p", { className: 'text-White text-[17px] font-semibold ' }, "Continue"))));
};
